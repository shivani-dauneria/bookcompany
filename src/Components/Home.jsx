    ...
    <>
      ...
      <div className="container"> 
        ...
        <div className="row-hm">
          ...
          <div className="part1-hm">
            <img src="https://bookxpert.co.in/assets/img/slide2.jpg" width="100%" alt="" />
          </div>
        ...
        <div className="row-hm">
          <div className="part1-hm">
            <img src="https://bookxpert.co.in/assets/img/slide3.jpg" width="100%" alt="" />
          </div>
          <div className="part1-hm">
        ...
        <div className="row-hm">
          ...
          <div className="part1-hm">
            <img src="https://bookxpert.co.in/assets/img/slide1.jpg" width="100%" alt="" />
          </div>
        ...
        <div className="row-hm">
          <div className="part1-hm">
            <img src="https://bookxpert.co.in/assets/img/aboutus.jpg" width="100%" alt="" />
          </div>
          <div className="part1-hm">
